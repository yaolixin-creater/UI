...
module.exports = {
    dev: {
        ...
        port: 8081,
        // can be overwritten by process.env.PORT, if port is in use,
    ...
    build: {
        ...
        index: path.resolve(__dirname, '../autoTemSta/index.html'),

        // Paths
        assetsRoot: path.resolve(__dirname, '../autoTemSta'),
        assetsSubDirectory: 'static',
        assetsPublicPath: '/',
